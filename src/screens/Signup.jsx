        ...
        <main className="flex items-center  justify-center h-screen bg-green-500 ">
            <div className="border-2 border-gray-300 bg-white p-4 w-96 shadow-md shadow-slate-600 rounded-xl">
                ...
                <form action="">
                    ...
                    <div className="mt-4">
                        <button className="border border-gray-400 bg-green-500 text-white px-20 p-2 text-xl rounded-full w-full ">
                            signup
                        </button>
                        <p className=' text-end'>Forgot Passowrd?</p>
                    </div>

                    <p className=' text-center text-zinc-500'>Already have an account?<Link to="/Login"> <span className=' text-green-500 font-bold'>Login now</span> </Link></p>
