...
const Footer = () => {
    ...
    return (
        <main className='relative max-w-[1640px] m-auto bg-green-600 text-white'>
            <div className=' font-bold pl-6 py-5 text-2xl'>
                Uber Eats
            </div>

            {/* Footer links */}

            <div className=' flex justify-between flex-wrap py-5 px-6  sm:px-6  sm:text-lg text-sm gap-3'>
                <ul>
                        ...
                        <div className='flex space-x-6 items-center justify-center'>
                            {
                                footer.map(({ id, icon, href }) => (
                                    <Link
                                        key={id}
                                        className=' text-white hover:text-black hover:scale-125 duration-300'
                                        to={href} >
                                        {icon}
                                    </Link>
